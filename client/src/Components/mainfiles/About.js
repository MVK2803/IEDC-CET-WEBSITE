...
function About({ sectionRef }) {
  ...
  return (
    <div ref={sectionRef} className="border-t-[1px] border-t-gray-800 pt-12 text-center flex flex-col gap-10 space-y-4 w-3/4 self-center text-white text-4xl mx-5 font-bold">
      <h>IEDC at CET</h>
